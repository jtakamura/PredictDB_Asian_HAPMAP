...
dosage = "/home/jennifer/Combined_Dosages_Asian/"+pop+"_"+chr+"_Dosages.txt"
samples="/home/jennifer/New_Dosages/CHB/testsampleasian.txt"


anot_file=gzip.open("/home/jennifer/Combine_test/"+pop+"_"+chr+"_annot2.txt.gz","wb")
snp_file=gzip.open("/home/jennifer/Combine_test/"+pop+"_"+chr+"_snp2.txt.gz","wb")
