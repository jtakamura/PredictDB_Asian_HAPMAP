...
anot_file=gzip.open("/home/jennifer/new_PredDB/elastic_net/prepare_data/genotypes/"+pop+"/"+pop+"_"+chr+"_SNPs_Location.txt.gz","wb")
snp_file=gzip.open("/home/jennifer/new_PredDB/elastic_net/prepare_data/genotypes/"+pop+"/"+pop+"_"+chr+"_SNP.txt.gz","wb")
