...
exp_1 = pd.read_csv("/home/jennifer/hapmap_expression_ensid/" + pops[0] + "_expression_ens.txt", delim_whitespace = True, index_col = 0)
for pop_num in range(1, len(pops)):
    exp_2 = pd.read_csv("/home/jennifer/hapmap_expression_ensid/" + pops[pop_num] + "_expression_ens.txt", delim_whitespace = True, index_col = 0)
